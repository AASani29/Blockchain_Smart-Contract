   ...
   //Structure to hold the details of a persons
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        */
        ...
        // ** Start code here. 2 lines approximately. **/
        require(tokenDetails[msg.sender].remainingTokens >= _count); // No error message
        require(tokenDetails[msg.sender].remainingTokens > 0);       // No error message
        require(_itemId <= 2);                                       // No error message
    ...
    //Hint : Use require to validate if "msg.sender" is equal to the "beneficiary".
     modifier onlyOwner {
        require(msg.sender == beneficiary); // No error message
    _;
    }
